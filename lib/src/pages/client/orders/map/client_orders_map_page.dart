...
import 'package:uber_clone_flutter/src/pages/client/orders/map/client_orders_map_controller.dart';
...
class _ClientOrdersMapPageState extends State<ClientOrdersMapPage> {
  ClientOrderMapController _con = new ClientOrderMapController();
