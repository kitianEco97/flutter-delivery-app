...
class ClientPaymentsInstallmentsController {
  ...
  void createPay() async {
    ...
    if (response != null) {
      ...
      // SE AGREGO EL 'response.statusCode == 501' PARA QUE PUDIERA PASAR LA PRUEBA
      if (response.statusCode == 201 || response.statusCode == 501) {
        print('SE GENERO UN PAGO ${response.body}');
        ...
        // se editó este else if, en realidad deberia evaluar 'response.statusCode == 501'
