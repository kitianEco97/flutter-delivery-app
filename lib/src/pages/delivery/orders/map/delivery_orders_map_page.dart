...
import 'package:uber_clone_flutter/src/pages/delivery/orders/map/delivery_orders_map_controller.dart';
...
class _DeliveryOrdersMapPageState extends State<DeliveryOrdersMapPage> {
  DeliveryOrderMapController _con = new DeliveryOrderMapController();
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned(top: 80, left: 15, child: _iconWaze()),
        ],
      ),
    );
  }
